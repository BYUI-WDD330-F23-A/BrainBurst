...
export function teamPage() {
  ...
  const teamPara = createElement("p", { className: "Score", textContent: "Hello from the other side", id: "teampara" });

  const teamContainer = createElement("div", {}, [teamHeading, teamPara, teamText]);
